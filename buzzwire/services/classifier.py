...
CATEGORY_KEYWORDS = {
    ...
    "jobs": ["job", "jobs", "career", "workforce", "layoff", "salary", "employee", "workplace", "engineer", "manager"],
...
TRIGGER_KEYWORDS = {
    ...
    "fear": ["layoff", "replace", "risk", "threat", "crisis", "automation", "job", "collapse"],
    "curiosity": ["study", "reveals", "quietly", "secret", "hidden", "new", "why", "trend"],
    "nationalism": ["india", "indian", "bharat", "rupee", "defense", "manufacturing"],
    "pride": ["wins", "record", "largest", "first", "global", "growth", "milestone"],
    "urgency": ["breaking", "urgent", "deadline", "race", "war", "crisis", "ban", "new rules"],
...
def score_virality(
    ...
    if re.search(r"\b(first|largest|record|billion|million|quietly|secret|ban|race)\b", text):
        score += 0.8
